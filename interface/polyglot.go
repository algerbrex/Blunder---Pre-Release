...
// The functions in the file provide the engine with
// a polyglot book loader. This is used to verify
// zobrist hashing is working correctly, and use opening
// books in the engine. The specification which this parser
// uses can be found at:
// https://web.archive.org/web/20130126233620/https://hardy.uhasselt.be/Toga/book_format.html
